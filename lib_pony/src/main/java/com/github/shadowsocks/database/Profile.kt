...
data class Profile(
        ...
        var short: String = "",//country code
        var country: String = "",//country
        var city: String = "",//city
        var extends: String = "",//local proxy list join '-'
        var raol: String = "1",//control flow around, 1-flow,0-not flow
        var inAuto: Boolean = true,//if false from server list else from smart list
        ...
        private class JsonParser(private val feature: Profile? = null) : ArrayList<Profile>() {
            ...
            private fun tryParse(json: JsonObject, fallback: Boolean = false): Profile? {
                ...
                return Profile().also {
                    ...
                    country = json["country"].optString?:""
                    short = json["short"].optString?:""
                    city = json["city"].optString?:""
                    ...
                    inAuto = json["inAuto"].optBoolean ?: inAuto
    ...
    fun serialize() {
        ...
        DataStore.privateStore.putString(Key.country, country)
        DataStore.privateStore.putString(Key.short, short)
        DataStore.privateStore.putString(Key.city, city)
        ...
        DataStore.privateStore.putString(Key.raol, raol)
        ...
        DataStore.privateStore.putBoolean(Key.inAuto, inAuto)
    ...
    fun deserialize() {
        ...
        country = DataStore.privateStore.getString(Key.country) ?: ""
        short = DataStore.privateStore.getString(Key.short) ?: ""
        city = DataStore.privateStore.getString(Key.city) ?: ""
        ...
        raol = DataStore.privateStore.getString(Key.raol, "no")?:"no"
        ...
        inAuto = DataStore.privateStore.getBoolean(Key.inAuto, true)
